                ...
                keys.forEach(key => {
                    switch (key){
                        ...
                        const income_deprivation_older_to = document.getElementById('income_deprivation_older_to-2');
                                    console.log("chart income_deprivation_older_from",income_deprivation_older_from.value)
                                    console.log("chart income_deprivation_older_to",income_deprivation_older_to.value)
                ...
                function F() {
                    ...
                    return [q(t.querySelector(A["filters-reset-button"]), "click", async()=>{
                        ...
                        if (p10) {
                            ...
                            v.setValue("CurrentEnergyConsumptionLower", Number(y != null ? y : 0)); //0
